...
<?php 
  if (isset($_GET['pesan_tambah'])) {
    echo '
    <div class="alert alert-success alert-dismissible fade show" role="alert"style="background-color:#ff69b4; color:white;">
  ...
  if (isset($_GET['pesan_edit'])) {
    ?>
    <div class="alert alert-<?php echo $_GET['pesan_edit']=='berhasil'?'success':'danger' ;?> alert-dismissible fade show" role="alert"style="background-color:#ff69b4;color:white;">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="mb-3">
	  ...
	  <input type="date" class="form-control" name="jangkawaktu" required>
	</div>
	<div class="mb-3">
...
<table border="1" class="table-hover-bg table table-bordered text-center teks-putih">
        <tr class="table-active fw-bolder text-center">
        
        <td>No</td><td>List Tugas</td><td>Jangka Waktu</td><td>Informasi</td><td>Aksi</td>
        </tr></div>
  ...
  <ul class="pagination" >
    ...
    $page=0;
      for ($i=0; $i < $perulangan; $i++) { 
        ?>
         <li class="page-item"><a class="page-link" href="index.php?halaman=todo&star=<?= $page ?>"style="background-color:#ffb6c1; color:white;"><?=$i+1?></a></li>
        <?php 
        $page+=5;
      }
     ?>
    <li class="page-item"><a class="page-link" href="#" style="background-color:#ffb6c1; color:white;">Next</a></li>
  </ul>
</nav>
</div>